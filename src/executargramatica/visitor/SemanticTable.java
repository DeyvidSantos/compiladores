...
public class SemanticTable {
   ...
   // 5 x 5 = TIPO X TIPO
    ...
    public static int resultType (Identificador.Tipo tp1, Identificador.Tipo tp2, VisitorLingaguem.Operation op){
    ...
    public static int getOpCode(VisitorLingaguem.Operation op){
        switch(op){
            case MAIS:
                return SUM;
            case MENOS:
